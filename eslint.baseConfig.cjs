  ...
  return tsEslint.config(
    {
      ...
      rules: {
        ...
        'bnt/no-angular-router': 'error',
        'bnt/wrap-args': 'error',
        'bnt/match-injected-property-name-to-type': ['error', {exclude: ['FormBuilder', 'ChangeDetectorRef', 'Actions']}],
        'bnt/signal-naming-convention': ['error', {exclude: ['input']}],
        ...
        '@typescript-eslint/naming-convention': [
          'error',
          {
            ...
            // exclude `[bracketed]` and `(parenthesized)` properties (to allow in host)
            // exclude specific exceptions (`ngsw-bypass`, `X-Requested-With`, etc.)
            filter: {
